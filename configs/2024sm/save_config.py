...
testname = "inst_sim_abx_2024summer"
setnum = 60
tripletnum = 4
iter_num = 1
...
for k in range(setnum):
    for iter in range(iter_num):
        k_config = setnum*iter+k
        count = 1
        for l in range(tripletnum):
            for test in [1, 2]:
                for inst in ["drums", "bass", "piano", "guitar", "residuals", "mix"]:
        ...
        with open('./configfiles/{}/config_set{}.yaml'.format(testname, k_config), 'w', encoding='utf-8') as f:
