            ...
            for test in [1, 2]:
                ...
                for inst in ["drums", "bass", "piano", "guitar", "residuals"]:
                    ...
                    for i, sample in enumerate(trackID):
                        ...
                        path_o = "./resources/set{}/{}/{}/{}_{}-{}.wav".format(k, inst, l, track[i], trackID[i], seg)
                        ...
                        dict_triplet[k][l]["test{}".format(test)][inst][track[i]]["filename"] = "{}_{}-{}.wav".format(track[i], trackID[i], seg)
