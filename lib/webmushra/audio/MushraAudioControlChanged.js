...
function MushraAudioControlChanged(_audioContext, _bufferSize, _reference, _conditions1, _conditions2, _errorHandler, _createAnchor35, _createAnchor70, _randomize, _switchBack) {
  this.audioContext = _audioContext;
  this.bufferSize = parseInt(_bufferSize);
  this.reference = _reference;
  this.conditions = _conditions1;
  this.conditions2 = _conditions2;
  ...
  this.conditions[this.conditions.length] = this.conditions2;
  //console.log("this.conditions[0]", this.conditions[0]);
  //console.log("this.conditions[1]", this.conditions[1]);
...
MushraAudioControlChanged.prototype.createLowerAnchor35 = function (_reference) {
...
MushraAudioControlChanged.prototype.createLowerAnchor70 = function (_reference) {
...
MushraAudioControlChanged.prototype.convolve = function (_src, _coefficients) {
...
MushraAudioControlChanged.prototype.removeEventListener = function (_index) {
  this.eventListeners[_index] = null;
};


MushraAudioControlChanged.prototype.addEventListener = function (_listenerFunction) {
  this.eventListeners[this.eventListeners.length] = _listenerFunction;
  return this.eventListeners.length - 1;
};

MushraAudioControlChanged.prototype.sendEvent = function (_event) {
...
MushraAudioControlChanged.prototype.getPosition = function () {
  return this.audioCurrentPosition;
};

MushraAudioControlChanged.prototype.getDuration = function () {
  return this.audioMaxPosition;
};

MushraAudioControlChanged.prototype.initAudio = function () {
...
MushraAudioControlChanged.prototype.freeAudio = function () {
  this.stop();
...
MushraAudioControlChanged.prototype.setLoopingActive = function (_loopingActive) {
  this.audioLoopingActive = _loopingActive;
};

MushraAudioControlChanged.prototype.isLoopingActive = function () {
  return this.audioLoopingActive;
};


MushraAudioControlChanged.prototype.process = function (audioProcessingEvent) {
  ...
  //if (this.audioCurrentPosition >= this.audioMaxPosition) {
  //  var event = {
  //    name: 'ended',
...
MushraAudioControlChanged.prototype.setLoopStart = function (_start) {
...
MushraAudioControlChanged.prototype.setLoopEnd = function (_end) {
...
MushraAudioControlChanged.prototype.setLoop = function (_start, _end) {
  var changed = false;
...
MushraAudioControlChanged.prototype.setPosition = function (_position, _setStartEnd) {
...
MushraAudioControlChanged.prototype.getNumSamples = function () {
  return this.audioMaxPosition;
};



MushraAudioControlChanged.prototype.play = function (_stimulus, _isReference) {
  if (_stimulus === null) {
  ...
  //audioBufferSourceNode.buffer = _stimulus.getAudioBuffer();
  ...
  // 再生終了判定
  //var isEnded = _stimulus.getAudioBuffer().ended;
  //console.log("isEnded", isEnded);
  //var audioElement = document.getElementById(_stimulus);
  //var isEnded = audioElement.ended;
  //console.log("isEnded:", isEnded)
  //var isEnded = false;
  //const audioElement = document.getElementById(_stimulus);
...
//MushraAudioControlChanged.prototype.isAudioEnded = function (_stimulus, _isReference) {
//  if (_stimulus === null) {
//    _stimulus = this.audioStimulus;
//  }
...
MushraAudioControlChanged.prototype.isAudioEnded = function () {
  if (this.audioCurrentPosition >= this.audioMaxPosition) {
    var event = {
      name: 'ended',
      position: this.audioCurrentPosition
    };
    this.sendEvent(event);
  }
};

MushraAudioControlChanged.prototype.getActiveStimulus = function () {
  return this.audioStimulus;
};

MushraAudioControlChanged.prototype.playReference = function () {
  var isPlayed = this.play(this.reference, true);
  //this.play(this.reference, true);
  //this.isAudioEnded(this.reference, true);
  if (this.switchBack) {
  ...
  //  self.isAudioEnded(self.reference, true);
  //}, 1000); // 1秒ごとにチェックする

  //再生が終了したらintervalをクリアする
  //var audioElement = this.reference.getAudioBuffer();
...
MushraAudioControlChanged.prototype.playCondition = function (_index) {
  //console.log("this.conditions[", _index, "]", this.conditions[_index]);
  //var isEnded = this.play(this.conditions[_index], false);
  var isPlayed = this.play(this.conditions[_index], false);
  //this.isAudioEnded(this.conditions[_index], false);
  if (this.switchBack) {
    if (this.switchBack) {
      this.setPosition(0, false);
    };
  ...
  //var self = this;
  //var intervalId = setInterval(function () {
  //  self.isAudioEnded(self.conditions[_index], true);
  //}, 1000); // 1秒ごとにチェックする

  //再生が終了したらintervalをクリアする
  //var audioElement = this.conditions[_index].getAudioBuffer();
  //audioElement.addEventListener("ended", function () {
  //  clearInterval(intervalId);
  //});
...
MushraAudioControlChanged.prototype.fadeOut = function (_stimulusFadeIn) {
  this.audioFadingIn = _stimulusFadeIn;
  this.audioFadingCurrentPositionRequest = 0;
  this.audioFadingActiveRequest = 1;
};

MushraAudioControlChanged.prototype.fadeIn = function (_stimulusFadeIn) {
  this.audioFadingIn = _stimulusFadeIn;
  this.audioFadingCurrentPositionRequest = 0;
...
MushraAudioControlChanged.prototype.pause = function () {
...
MushraAudioControlChanged.prototype.surpressLoop = function () {
  this.pause();
...
MushraAudioControlChanged.prototype.stop = function () {
  this.audioCurrentPositionRequest = this.audioLoopStart;
  if (this.audioPlaying === true) {
    this.fadeOut(null);
  }
...
MushraAudioControlChanged.prototype.getConditions = function () {
  return this.conditions;
};

MushraAudioControlChanged.prototype.getReferenceIndexOfConditions = function () {
