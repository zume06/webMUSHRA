...
PairedComparisonChangedPage.prototype.render = function (_parent) {
  ...
  var radioChoice1 = $("<div id='radio-container'>\<span><b>timber（音色）</b></span> <div id='radio-choice1' data-role='controlgroup' data-type='horizontal'>\
    <input type='radio' name='radio-choice1' id='radio-choice-a1-1' value='1'>\
    <label for='radio-choice-a1-1'>A+</label>\
    <input type='radio' name='radio-choice1' id='radio-choice-a2-1' value='2'>\
    <label for='radio-choice-a2-1'>A-</label>\
    <input type='radio' name='radio-choice1' id='radio-choice-c-1' value='3'>\
    <label for='radio-choice-c-1'>N/A</label>\
    <input type='radio' name='radio-choice1' id='radio-choice-b2-1' value='4'>\
    <label for='radio-choice-b2-1'>B-</label>\
    <input type='radio' name='radio-choice1' id='radio-choice-b1-1' value='5'>\
  ...
  var radioChoice2 = $("<div id='radio-container'>\<span><b>rhythm（リズム）</b></span><div id='radio-choice2' data-role='controlgroup' data-type='horizontal'>\
    <input type='radio' name='radio-choice2' id='radio-choice-a1-2' value='1'>\
    <label for='radio-choice-a1-2'>A+</label>\
    <input type='radio' name='radio-choice2' id='radio-choice-a2-2' value='2'>\
    <label for='radio-choice-a2-2'>A-</label>\
    <input type='radio' name='radio-choice2' id='radio-choice-c-2' value='3'>\
    <label for='radio-choice-c-2'>N/A</label>\
    <input type='radio' name='radio-choice2' id='radio-choice-b2-2' value='4'>\
    <label for='radio-choice-b2-2'>B-</label>\
    <input type='radio' name='radio-choice2' id='radio-choice-b1-2' value='5'>\
  ...
  var radioChoice3 = $("<div id='radio-container'>\<span><b>melody（メロディ）</b></span><div id='radio-choice3' data-role='controlgroup' data-type='horizontal'>\
    <input type='radio' name='radio-choice3' id='radio-choice-a1-3' value='1'>\
    <label for='radio-choice-a1-3'>A+</label>\
    <input type='radio' name='radio-choice3' id='radio-choice-a2-3' value='2'>\
    <label for='radio-choice-a2-3'>A-</label>\
    <input type='radio' name='radio-choice3' id='radio-choice-c-3' value='3'>\
    <label for='radio-choice-c-3'>N/A</label>\
    <input type='radio' name='radio-choice3' id='radio-choice-b2-3' value='4'>\
    <label for='radio-choice-b2-3'>B-</label>\
    <input type='radio' name='radio-choice3' id='radio-choice-b1-3' value='5'>\
  ...
  var radioChoice4 = $("<div id='radio-container'>\<span><b>total（総合）</b></span><div id='radio-choice4' data-role='controlgroup' data-type='horizontal'>\
    <input type='radio' name='radio-choice4' id='radio-choice-a1-4' value='1'>\
    <label for='radio-choice-a1-4'>A+</label>\
    <input type='radio' name='radio-choice4' id='radio-choice-a2-4' value='2'>\
    <label for='radio-choice-a2-4'>A-</label>\
    <input type='radio' name='radio-choice4' id='radio-choice-c-4' value='3'>\
    <label for='radio-choice-c-4'>／</label>\
    <input type='radio' name='radio-choice4' id='radio-choice-b2-4' value='4'>\
    <label for='radio-choice-b2-4'>B-</label>\
    <input type='radio' name='radio-choice4' id='radio-choice-b1-4' value='5'>\
...
PairedComparisonChangedPage.prototype.store = function () {
  ...
  var choice1 = new PairedComparisonChoice();
  choice1.answer = this.choice1

  var choice2 = new PairedComparisonChoice();
  choice2.answer = this.choice2

  var choice3 = new PairedComparisonChoice();
  choice3.answer = this.choice3

  var choice4 = new PairedComparisonChoice();
  choice4.answer = this.choice4

  choice1.time = this.time;
  trial.responses[trial.responses.length] = choice1.answer;
  trial.responses[trial.responses.length] = choice2.answer;
  trial.responses[trial.responses.length] = choice3.answer;
  trial.responses[trial.responses.length] = choice4.answer;
