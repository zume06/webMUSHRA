...
PairedComparisonChangedPage.prototype.render = function (_parent) {
  ...
  if (
    radioChoice1.find("input[type='radio']").is(":checked") &&
    radioChoice2.find("input[type='radio']").is(":checked") &&
    radioChoice3.find("input[type='radio']").is(":checked") &&
    radioChoice4.find("input[type='radio']").is(":checked")
  ) {
