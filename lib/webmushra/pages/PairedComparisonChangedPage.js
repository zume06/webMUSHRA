...
PairedComparisonChangedPage.prototype.render = function (_parent) {
  ...
  var questionsContainer = $("<div class='questions-container'></div>");
  for (var i = 0; i < 4; i++) {
    var questionContainer = $("<div class='question-container'></div>");
    var radioChoice = $("A <div id='radio-choice' data-role='controlgroup' data-type='horizontal'>\
      <input type='radio' name='radio-choice' id='radio-choice-a1' value='a1'>\
      <label for='radio-choice-a1'> </label>\
      <input type='radio' name='radio-choice' id='radio-choice-a2' value='a2'>\
      <label for='radio-choice-a2'> </label>\
      <input type='radio' name='radio-choice' id='radio-choice-c' value='c'>\
      <label for='radio-choice-c'> </label>\
      <input type='radio' name='radio-choice' id='radio-choice-b2' value='b2'>\
      <label for='radio-choice-b2'> </label>\
      <input type='radio' name='radio-choice' id='radio-choice-b1' value='b1'>\
      <label for='radio-choice-b1'> </label>\
    </div> B");
    ...
    questionContainer.append(radioChoice);
