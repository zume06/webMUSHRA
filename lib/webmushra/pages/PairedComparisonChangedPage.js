...
PairedComparisonChangedPage.prototype.store = function () {
  ...
  choice1.answer = radio1

  var choice2 = new PairedComparisonChoice();
  choice2.answer = radio2

  var choice3 = new PairedComparisonChoice();
  choice3.answer = radio3

  var choice4 = new PairedComparisonChoice();
  choice4.answer = radio4

  choice1.time = this.time;
  trial.responses[trial.responses.length] = choice1;
  trial.responses[trial.responses.length] = choice2;
  trial.responses[trial.responses.length] = choice3;
  trial.responses[trial.responses.length] = choice4;
