...
PairedComparisonChangedPage.prototype.render = function (_parent) {
  ...
  var radioChoice1 = $("<div id='radio-choice1' data-role='controlgroup' data-type='horizontal'>\
    <input type='radio' name='radio-choice1' id='radio-choice-a1-1' value='a1-1'>\
    <label for='radio-choice-a1-1'>A+</label>\
    <input type='radio' name='radio-choice1' id='radio-choice-a2-1' value='a2-1'>\
    <label for='radio-choice-a2-1'>A-</label>\
    <input type='radio' name='radio-choice1' id='radio-choice-c-1' value='c-1'>\
    <label for='radio-choice-c-1'>N/A</label>\
    <input type='radio' name='radio-choice1' id='radio-choice-b2-1' value='b2-1'>\
    <label for='radio-choice-b2-1'>B-</label>\
    <input type='radio' name='radio-choice1' id='radio-choice-b1-1' value='b1-1'>\
    <label for='radio-choice-b1-1'>B+</label>\
  </div>");

  radioChoice1.find("input[type='radio']").bind("change", (function () {
    radioChecked1 = true;
    checkAndUnlockNextButton(radioChecked1, radioChecked2, radioChecked3, radioChecked4);
  }
  ).bind(this));

  tdResponse.append(radioChoice1);

  var radioChoice2 = $("<div id='radio-choice2' data-role='controlgroup' data-type='horizontal'>\
    <input type='radio' name='radio-choice2' id='radio-choice-a1-2' value='a1-2'>\
    <label for='radio-choice-a1-2'>A+</label>\
    <input type='radio' name='radio-choice2' id='radio-choice-a2-2' value='a2-2'>\
    <label for='radio-choice-a2-2'>A-</label>\
    <input type='radio' name='radio-choice2' id='radio-choice-c-2' value='c-2'>\
    <label for='radio-choice-c-2'>N/A</label>\
    <input type='radio' name='radio-choice2' id='radio-choice-b2-2' value='b2-2'>\
    <label for='radio-choice-b2-2'>B-</label>\
    <input type='radio' name='radio-choice2' id='radio-choice-b1-2' value='b1-2'>\
  ...
  var radioChoice3 = $("<div id='radio-choice3' data-role='controlgroup' data-type='horizontal'>\
    <input type='radio' name='radio-choice3' id='radio-choice-a1-3' value='a1-3'>\
    <label for='radio-choice-a1-3'>A+</label>\
    <input type='radio' name='radio-choice3' id='radio-choice-a2-3' value='a2-3'>\
    <label for='radio-choice-a2-3'>A-</label>\
    <input type='radio' name='radio-choice3' id='radio-choice-c-3' value='c-3'>\
    <label for='radio-choice-c-3'>N/A</label>\
    <input type='radio' name='radio-choice3' id='radio-choice-b2-3' value='b2-3'>\
    <label for='radio-choice-b2-3'>B-</label>\
    <input type='radio' name='radio-choice3' id='radio-choice-b1-3' value='b1-3'>\
  ...
  var radioChoice4 = $("<div id='radio-choice4' data-role='controlgroup' data-type='horizontal'>\
    <input type='radio' name='radio-choice4' id='radio-choice-a1-4' value='a1-4'>\
    <label for='radio-choice-a1-4'>A+</label>\
    <input type='radio' name='radio-choice4' id='radio-choice-a2-4' value='a2-4'>\
    <label for='radio-choice-a2-4'>A-</label>\
    <input type='radio' name='radio-choice4' id='radio-choice-c-4' value='c-4'>\
    <label for='radio-choice-c-4'>N/A</label>\
    <input type='radio' name='radio-choice4' id='radio-choice-b2-4' value='b2-4'>\
    <label for='radio-choice-b2-4'>B-</label>\
    <input type='radio' name='radio-choice4' id='radio-choice-b1-4' value='b1-4'>\
...
function checkAndUnlockNextButton(radioChecked1, radioChecked2, radioChecked3, radioChecked4) {
  var allchecked = false;
  if (radioChecked1 && radioChecked2 && radioChecked3 && radioChecked4) {
    allchecked = true;
  }
  var notallNA = true;
  if ($('#radio-choice1 :radio:checked') == 2 && $('#radio-choice2 :radio:checked') == 2 && $('#radio-choice3 :radio:checked') == 2 && $('#radio-choice4 :radio:checked') == 2) {
    notallNA = false;
  }
  if (allchecked && notallNA) {
...
PairedComparisonChangedPage.prototype.save = function () {
  ...
  this.choice = (radio1.length > 0) ? radio1[0].value : null;
  //loop
