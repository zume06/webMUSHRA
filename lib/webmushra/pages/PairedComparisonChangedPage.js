...
function checkAndUnlockNextButton(radioChecked1, radioChecked2, radioChecked3, radioChecked4, isPlayedRef, isPlayedA, isPlayedB) {
  ...
  //}
  var notallNA = false;
  if ($('#radio-choice1 :radio:checked').val() == "NA" && $('#radio-choice2 :radio:checked').val() == "NA" && $('#radio-choice3 :radio:checked').val() == "NA") {
    notallNA = false;
  } else {
    notallNA = true;
  }
  ...
  if ($('#radio-choice4 :radio:checked').val() == "NA") {
    nottotalna = false;
  } else {
    nottotalna = true;
  }
  ...
  //console.log("notallNA", notallNA);
  //console.log("allplayed", allplayed);
  //console.log("allplayed", nottotalna);
...
PairedComparisonChangedPage.prototype.store = function () {
  ...
  if (trial === null) {
    ...
    trial.setno = this.pageConfig.setno;
